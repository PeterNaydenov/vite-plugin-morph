...
2. **Check for existing branches before creating new one**:
   ...
   b. Find the highest feature number across all sources for short-name:
...
5. Write to specification to SPEC_FILE using the template structure, replacing placeholders with concrete details derived from the feature description (arguments) while preserving section order and headings.
...
6. **Specification Quality Validation**: After writing the initial spec, validate it against quality criteria:
   ...
   **Feature**: [Link to spec.md]
   ...
   1. List of failing items and specific issues
...
**NOTE:** The script creates and checks out of new branch and initializes a spec file before writing.
...
5. **Think like a tester**: Every vague requirement should fail to "testable and unambiguous" checklist item
