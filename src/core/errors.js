 ...
 * @returns {import('./types/processing.js').MorphPluginError} Enhanced error object
 */
 ...
 * @param {import('./types/processing.js').SourceLocation} [location] - Warning location
 * @param {string} [code] - Warning code
 * @returns {import('./types/processing.js').MorphPluginError} Warning object
 */
 ...
 * @param {import('./types/processing.js').MorphPluginError} error - Error object
 ...
 * @param {import('./types/processing.js').MorphPluginError} error - Error object
 * @returns {import('./types/processing.js').FormattedError} Formatted error for files
 */
 ...
 * @param {string} filePath - File path
 * @param {import('./types/processing.js').SourceLocation} [location] - Error location
 * @param {string} [details] - Additional error details
 * @returns {import('./types/processing.js').MorphPluginError} Malformed template error
 */
 ...
 * @returns {import('./types/processing.js').MorphPluginError} Invalid template tag error
 */
 ...
 * @param {string} filePath - File path
 * @returns {import('./types/processing.js').MorphPluginError} Missing template error
 */
 ...
 * @param {string} filePath - File path
 * @param {import('./types/processing.js').SourceLocation} [location] - Error location
 * @returns {import('./types/processing.js').MorphPluginError} Invalid script tag error
 */
 ...
 * @param {string} filePath - File path
 * @param {import('./types/processing.js').SourceLocation} [location] - Error location
 * @returns {import('./types/processing.js').MorphPluginError} Invalid style tag error
 */
